    ...
    defaults = [
        {
            "name": "Free",
            "price_monthly": 0,
            "limits_json": {"websites": 1, "events_per_month": 50000, "retention_days": 7},
            "features_json": {
                "heatmaps": False,
        ...
        },
        {
            "name": "Starter",
            "price_monthly": 49,
            "limits_json": {"websites": 3, "events_per_month": 250000, "retention_days": 30},
            "features_json": {
                "heatmaps": True,
                "integrity_monitoring": True,
                "prescriptions": False,
        ...
        },
        {
            "name": "Pro",
            "price_monthly": 149,
            "limits_json": {"websites": 10, "events_per_month": 1000000, "retention_days": 90},
            "features_json": {
                "heatmaps": True,
                "integrity_monitoring": True,
                "prescriptions": True,
        ...
        },
        {
            "name": "Business",
            "price_monthly": 399,
            "limits_json": {"websites": 25, "events_per_month": 5000000, "retention_days": 180},
            "features_json": {
                "heatmaps": True,
                "integrity_monitoring": True,
                "prescriptions": True,
